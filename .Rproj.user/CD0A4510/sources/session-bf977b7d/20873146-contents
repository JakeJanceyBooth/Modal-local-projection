...
#
# In the saved DGP-5 results:
#   Mean LP and VAR target the population mean response;
#   Median LP targets the population median response;
#   Modal LP targets the population modal response.
#
# The truth column is therefore estimator-specific in this DGP.
...
required_response_columns <- c(
  "dgp", "estimator", "sample_size", "horizon",
  "truth", "average_estimate"
)
